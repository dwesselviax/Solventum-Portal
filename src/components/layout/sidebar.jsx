...
import {
  ...
  ChevronRight, BookOpen, GraduationCap, ClipboardList, FileSpreadsheet,
  FlaskConical, Smile, Users, ExternalLink, Globe, Megaphone,
} from 'lucide-react';

const NAV_ITEMS = [
  { href: '/dashboard', label: 'Dashboard', icon: LayoutDashboard, roles: ['all'] },
  { type: 'divider', label: 'Commerce', roles: ['orthodontist', 'dso', 'sales_rep', 'ar', 'ap', 'csr'] },
  { href: '/orders', label: 'Orders', icon: ShoppingCart, roles: ['orthodontist', 'dso', 'sales_rep', 'ar', 'csr'] },
  { href: '/quotes', label: 'Quotes', icon: MessageSquareQuote, roles: ['orthodontist', 'dso', 'sales_rep', 'csr'] },
  { href: '/contracts', label: 'Contracts', icon: FileText, roles: ['orthodontist', 'dso', 'sales_rep', 'ar'] },
  { href: '/invoices', label: 'Invoices', icon: Receipt, roles: ['orthodontist', 'dso', 'sales_rep', 'ar', 'ap'] },
  ...
  { type: 'divider', label: 'Clinical', roles: ['orthodontist', 'dso'] },
  { href: '/clarity', label: 'Treatment Plans', icon: Smile, roles: ['orthodontist', 'dso'] },
  { href: 'https://clarity.solventum.com', label: 'Clarity Portal', icon: ExternalLink, roles: ['orthodontist', 'dso'], external: true },
  { type: 'divider', label: 'Marketing & Resources', roles: ['orthodontist', 'dso', 'sales_rep'] },
  { href: '/marketing', label: 'Marketing Materials', icon: Megaphone, roles: ['orthodontist', 'dso', 'sales_rep'] },
  ...
  { type: 'divider', label: 'Partner Management', roles: ['operations'] },
  { href: '/partners', label: 'API Partners', icon: Globe, roles: ['operations'] },
  { type: 'divider', label: 'Resources', roles: ['orthodontist', 'dso', 'sales_rep', 'operations'] },
  { href: '/documentation', label: 'Documentation', icon: BookOpen, roles: ['orthodontist', 'dso', 'sales_rep', 'operations'] },
  { href: '/training', label: 'Training', icon: GraduationCap, roles: ['orthodontist', 'dso', 'sales_rep'] },
